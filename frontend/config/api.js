...
export async function apiFetch(path, { method="GET", headers={}, body, timeout=60000 } = {}) {
...
// POST /api/recipes/prepare  { ingredients, timeMax?, servings? }
export const postPrepare = (ingredients, opts = {}, timeout = 65000) => {
  const { timeMax = null, servings = null } = opts;
  return apiPost("/api/recipes/prepare", { ingredients, timeMax, servings }, timeout);
};
